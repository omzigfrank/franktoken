...
export default {
  ...
  async fetch(range) {
    ...
    const sum = summarize(events, r, { costEstimated: true, defaultModel: 'gpt-5' })
    ...
    for (const mName of models) {
      const ms = summarize(events.filter((e) => e.model === mName), r, { costEstimated: true, defaultModel: 'gpt-5' })
